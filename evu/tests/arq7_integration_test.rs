...
fn test_arq7_show_records_unencrypted() {
    ...
    cmd.assert()
        ...
        .stdout(predicate::str::contains("Original Path: /Users/developer/Projects/2024-12-arq-decryption/arq_backup_source"))
...
fn test_arq7_show_file_versions_unencrypted_subfolder_found() {
    ...
    cmd.arg("arq7")
        ...
        .arg("show-file-versions")
        .arg("--file")
        .arg("/Users/developer/Projects/2024-12-arq-decryption/arq_backup_source/subfolder/file 2.txt");
...
fn test_arq7_show_file_versions_not_found() {
    ...
    cmd.arg("arq7")
        ...
        .arg("show-file-versions")
        .arg("--file")
        .arg("/Users/developer/Projects/2024-12-arq-decryption/arq_backup_source/nonexistentfile.txt");
...
fn test_arq7_show_folder_versions_unencrypted_root_found() {
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("Versions for folder: /Users/developer/Projects/2024-12-arq-decryption/arq_backup_source"))
        .stdout(predicate::str::contains("Record Timestamp:"))
...
fn test_arq7_restore_file_unencrypted() {
    ...
    let file_to_restore = "/Users/developer/Projects/2024-12-arq-decryption/arq_backup_source/file 1.txt";
...
fn test_arq7_restore_file_encrypted() {
    ...
    // Path adjusted to the flawed LocalPath from test data
    let file_to_restore = "/Users/developer/Projects/2024-12-arq-decryption/arq_backup_source/subfolder/file 2.txt";
    let output_dir = temp_dir();
...
fn test_arq7_restore_folder_unencrypted() {
    ...
    let folder_to_restore = "/Users/developer/Projects/2024-12-arq-decryption/arq_backup_source/subfolder";
